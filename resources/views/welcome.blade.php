  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          <li><a href="index.html" class="active">Dashboard<br></a></li>
  ...
  <main class="main">
      ...
      <div class="container">
        <div class="row gy-4 d-flex justify-content-between">
          <div class="order-2 col-lg-6 order-lg-1 d-flex flex-column justify-content-center">
            ...
            <form action="#" class="mb-3 form-search d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="order-1 col-lg-5 order-lg-2 hero-img" data-aos="zoom-out">
            <img src="assets/img/hero-img.svg" class="mb-3 img-fluid mb-lg-0" alt="">
          </div>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="100">
            <div class="flex-shrink-0 icon"><i class="fa-solid fa-cart-flatbed"></i></div>
            <div>
          ...
          <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="200">
            <div class="flex-shrink-0 icon"><i class="fa-solid fa-truck"></i></div>
            <div>
          ...
          <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="300">
            <div class="flex-shrink-0 icon"><i class="fa-solid fa-truck-ramp-box"></i></div>
            <div>
    ...
    <section id="about" class="about section">
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="order-first col-lg-6 position-relative align-self-start order-lg-last" data-aos="fade-up" data-aos-delay="200">
            <img src="assets/img/about.jpg" class="img-fluid" alt="">
            <a href="https://www.youtube.com/watch?v=Y7f98aduVJ8" class="glightbox pulsating-play-btn"></a>
          </div>

          <div class="order-last col-lg-6 content order-lg-first" data-aos="fade-up" data-aos-delay="100">
            <h3>About Us</h3>
            <p>
    ...
    <section id="features" class="features section">
      ...
      <div class="container">
        ...
        <div class="row gy-4 align-items-center features-item">
          <div class="order-1 col-md-5 order-md-2 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="200">
            <img src="assets/img/features-2.jpg" class="img-fluid" alt="">
          </div>
          <div class="order-2 col-md-7 order-md-1" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="row gy-4 align-items-center features-item">
          <div class="order-1 col-md-5 order-md-2 d-flex align-items-center" data-aos="zoom-out">
            <img src="assets/img/features-4.jpg" class="img-fluid" alt="">
          </div>
          <div class="order-2 col-md-7 order-md-1" data-aos="fade-up">
